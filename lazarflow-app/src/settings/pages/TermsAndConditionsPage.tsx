...
export const TermsAndConditionsPage: React.FC<TermsAndConditionsPageProps> = ({ navigation }) => {
    return (
...
const Section = ({ title, children, highlighted }: any) => (
...
const styles = StyleSheet.create({
    ...
    backButton: { position: 'absolute', top: 24, left: 24, zIndex: 10, padding: 5 },
    ...
    intro: { fontSize: 15, fontFamily: Theme.fonts.inter.regular, color: Theme.colors.textSecondary, lineHeight: 22, marginBottom: 30 },
    section: { marginBottom: 32, padding: 16, borderRadius: 12, borderWidth: 1, borderColor: 'transparent' },
    highlightedSection: { backgroundColor: 'rgba(234, 67, 53, 0.05)', borderColor: 'rgba(234, 67, 53, 0.1)' },
    sectionHeader: { flexDirection: 'row', alignItems: 'center', marginBottom: 12 },
    sectionTitle: { fontSize: 18, fontFamily: Theme.fonts.inter.bold, color: Theme.colors.accent },
    highlightTitle: { color: Theme.colors.danger },
    sectionContent: { fontSize: 15, fontFamily: Theme.fonts.inter.regular, color: Theme.colors.textPrimary, lineHeight: 24 },
    highlightIcon: { marginRight: 10 },
    bulletRow: { flexDirection: 'row', marginBottom: 8, paddingLeft: 10 },
    bullet: { color: Theme.colors.accent, fontSize: 20, marginRight: 10 },
    bulletContent: { color: Theme.colors.textPrimary, fontFamily: Theme.fonts.inter.regular, fontSize: 15, lineHeight: 24, flex: 1 },
