...
export const PrivacyPolicyPage: React.FC<PrivacyPolicyPageProps> = ({ navigation }) => {
    return (
...
const BulletPoint = ({ label, content }: any) => (
...
const styles = StyleSheet.create({
    ...
    scrollContent: { padding: 24, paddingTop: Platform.OS === 'android' ? StatusBar.currentHeight! + 20 : 24 },
    header: { marginBottom: 30, alignItems: 'center' },
    headerIcon: { marginBottom: 15, backgroundColor: 'rgba(26, 115, 232, 0.1)', padding: 16, borderRadius: 50 },
    title: { fontSize: 28, fontFamily: Theme.fonts.inter.bold, color: Theme.colors.textPrimary, marginBottom: 8 },
    lastUpdated: { fontSize: 14, fontFamily: Theme.fonts.inter.regular, color: Theme.colors.textSecondary },
    section: { marginBottom: 32 },
    sectionTitle: { fontSize: 20, fontFamily: Theme.fonts.inter.bold, color: Theme.colors.accent, marginBottom: 12 },
    sectionContent: { fontSize: 15, fontFamily: Theme.fonts.inter.regular, color: Theme.colors.textPrimary, lineHeight: 24 },
    bulletPoint: { flexDirection: 'row', paddingLeft: 4, marginTop: 8 },
    bullet: { fontSize: 18, color: Theme.colors.accent, marginRight: 10, lineHeight: 22 },
    bulletText: { flex: 1, fontSize: 15, fontFamily: Theme.fonts.inter.regular, color: Theme.colors.textPrimary, lineHeight: 24 },
    bold: { fontFamily: Theme.fonts.inter.bold, color: Theme.colors.textPrimary },
    contactCard: { flexDirection: 'row', alignItems: 'center', backgroundColor: Theme.colors.secondary, padding: 20, borderRadius: 16, marginTop: 10, borderWidth: 1, borderColor: Theme.colors.border },
    contactText: { marginLeft: 15, fontSize: 16, color: Theme.colors.accent, fontFamily: Theme.fonts.inter.bold },
    footerContent: { marginTop: 20, paddingBottom: 40, alignItems: 'center' },
    footerText: { color: Theme.colors.textSecondary, fontFamily: Theme.fonts.inter.regular, fontSize: 14 }
});
