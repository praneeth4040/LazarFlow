...
The application is built with **React Native (Expo)** and communicates with a custom backend (`8b2b-49-204-103-59.ngrok-free.app`) and **Supabase** for authentication and data persistence.
...
The application interacts with `https://8b2b-49-204-103-59.ngrok-free.app` (proxied or direct) for the following key resources:
