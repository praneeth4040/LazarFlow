...
| :--- | :--- | :--- | :--- |
| `https://8b2b-49-204-103-59.ngrok-free.app/storage/themes/:path` | GET | `Image` components in React Native | Used to load theme preview images directly from the backend storage. |
