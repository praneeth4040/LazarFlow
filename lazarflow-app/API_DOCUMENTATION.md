...
| :--- | :--- | :--- | :--- |
| `https://4a1447cb531c.ngrok-free.app/storage/themes/:path` | GET | `Image` components in React Native | Used to load theme preview images directly from the backend storage. |
